package ProductPlacementService.services;

import ProductPlacementService.entities.Product;
import ProductPlacementService.repositories.ProductRepository;
...
public class ProductService {
    ...
    @Transactional(readOnly = true)
    public List<Product> findOrganizationProducts(Long organizationId) {
