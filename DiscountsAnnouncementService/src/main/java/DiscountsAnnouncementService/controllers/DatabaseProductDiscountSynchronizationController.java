...
import DiscountsAnnouncementService.services.ProductDiscountService;
import org.springframework.web.bind.annotation.*;

@RestController
@RequestMapping(value="/DiscountsAnnouncementService/ProductDiscountSynchronization", method = {RequestMethod.GET, RequestMethod.POST})
